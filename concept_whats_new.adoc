...
=== Kubernetes PV 데이터 보고

Cloud Insights에서 수집한 Kubernetes 영구 볼륨(PV) 정보를 이제 보고에서 사용할 수 있으므로 비용청구, 추세, 예측, TTF 계산, 기타 Kubernetes 클러스터, 네임스페이스, 워크로드 등에 대한 메트릭의 비즈니스 보고 기능을 제공합니다.
...
* https://[] (참고: NetApp Support에 로그인해야 합니다.)
* https://[]
