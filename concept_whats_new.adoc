...
iSCSI 볼륨 지연 시간 메트릭은 대시보드, 알림 등에서 사용할 수 있습니다. iSCSI Latency 메트릭을 수집하려면 Kubernetes Collector "Modify Deployment(배포 수정)" 메뉴 항목에서 _Network Performance(네트워크 성능) 및 Map_을 켭니다.
