...
* OpenShift 4.6-4.8에서 실행 중인 경우 아래의 * OpenShift Instructions * 를 따라야 합니다.
...
* NetApp Kubernetes Monitoring Operator의 설치는 테스트를 거쳤으며 AWS EKS 1.18-1.21, OpenShift 4.6-4.8 및 Rancher 2.4-2.6과 함께 작동할 것으로 예상됩니다.
