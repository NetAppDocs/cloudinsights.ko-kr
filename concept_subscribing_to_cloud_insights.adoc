...
워크로드 보안은 다음 MU(Managed Unit) 수에 따라 사용된 노드가 하이엔드, 미드레인지 또는 엔트리 레벨인지 여부에 따라 측정됩니다.
...
| 하이엔드 노드 1개 | 700, 800, 900, 9xxx | 80개의 관리형 유닛 


| 미드레인지 노드 1개 | 300, 400, 500, 8x00입니다 | 40개의 관리형 유닛 


| 엔트리 레벨 노드 1개 | 1xx, 2xx, 2xxx | 20개의 관리 유닛 


| 1 소프트웨어 ONTAP | CVO, FSx | 10개의 관리 유닛 


| 1 알 수 없는 노드 |  | 80개의 관리형 유닛 
|===
