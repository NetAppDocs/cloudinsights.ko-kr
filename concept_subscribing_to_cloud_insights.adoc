...
* 설치하고
* Cohesity SmartFiles를 참조하십시오
* Dell EMC Data Domain을 참조하십시오
...
정액 요금제 계산기는 필요한 관리 장치 수를 기준으로 월별 예상 Cloud Insights 비용을 제공합니다. 현재 값이 미리 채워지고 이러한 값을 조정하여 예상 향후 성장을 계획하는 데 도움을 줄 수 있습니다. 인프라, Kubernetes 또는 둘 다에 대한 값을 조정할 수 있습니다.
