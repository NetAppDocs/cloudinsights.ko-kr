...
NOTE: 에 등록하려면 등록해야 합니다  support entitlement and accessing support,지원을 활성화합니다 NetApp Cloud 제품: 등록하려면 NetApp로 이동하십시오 link:https://register.netapp.com["클라우드 데이터 서비스 지원 등록"].
